    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <div className="border-b border-[var(--border)] bg-white">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-5 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 font-body text-sm text-[var(--muted)]">
            <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3 7v12" /><path strokeLinecap="round" strokeLinejoin="round" d="M3 19h18" /><path strokeLinecap="round" strokeLinejoin="round" d="M3 13h15a3 3 0 0 1 3 3v3" /><path strokeLinecap="round" strokeLinejoin="round" d="M6 13v-1.5A1.5 1.5 0 0 1 7.5 10h2A1.5 1.5 0 0 1 11 11.5V13" /></svg>
            <span>Sleeps <strong
                className="text-[var(--text)]"
